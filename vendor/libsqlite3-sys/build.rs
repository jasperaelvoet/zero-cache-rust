...
fn main() {
        ...
        || cfg!(feature = "loadable_extension")
    {
        ...
        build_linked::main(&out_dir, &out_path);
    } else if cfg!(feature = "zero-sqlite3")
        || cfg!(feature = "bundled")
...
mod build_bundled {
    ...
    pub fn main(out_dir: &str, out_path: &Path) {
        ...
        // Keep this list in lockstep with deps/defines.gypi from
        // @rocicorp/zero-sqlite3@1.1.2.  The amalgamation itself contains the
        // BEGIN CONCURRENT and WAL2 implementation; these defines reproduce
        // the official Zero server build rather than rusqlite's stock bundle.
        cfg.file(format!("{lib_name}/sqlite3.c"))
            .flag("-DHAVE_INT16_T=1")
            .flag("-DHAVE_INT32_T=1")
            .flag("-DHAVE_INT8_T=1")
            .flag("-DHAVE_STDINT_H=1")
            .flag("-DHAVE_UINT16_T=1")
            .flag("-DHAVE_UINT32_T=1")
            .flag("-DHAVE_UINT8_T=1")
            .flag("-DHAVE_USLEEP=1")
            .flag("-DSQLITE_DEFAULT_CACHE_SIZE=-16000")
            ...
            .flag("-DSQLITE_ENABLE_PERCENTILE")
            .flag("-DSQLITE_ENABLE_RTREE")
            .flag("-DSQLITE_ENABLE_STAT4")
            .flag("-DSQLITE_ENABLE_STMT_SCANSTATUS")
            .flag("-DSQLITE_ENABLE_UPDATE_DELETE_LIMIT")
            ...
            .flag("-DSQLITE_STAT4_SAMPLES=128")
            .flag("-DSQLITE_THREADSAFE=2")
            .flag("-DSQLITE_TRACE_SIZE_LIMIT=32")
            .flag("-DSQLITE_USE_URI=1")
            .flag("-DHAVE_ISNAN")
